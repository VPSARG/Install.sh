...
cat << EOF
              ...
              KEY GENERADOR By @Pablo_Ezekiel
...
atualizar_geb () {
wget -O $HOME/instger.sh https://raw.githubusercontent.com/ARGENTO-VPS/GENERADOR-NEW-ULTIMATE-ORIGINAL/master/instgerador.sh &>/dev/null
